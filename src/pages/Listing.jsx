...
export default function Listing() {
  ...
  return (
    <main>
      ...
      {shareLinkCopied && (
        <p className='fixed top-[23%] right-[5%] font-semibold border-2 border-gray-400 rounded-md bg-white z-10 p-2'>Link Copied
        </p>
      )}
        ...
        <div className='w-full'>
          ...
          <p className='flex items-center mt-6 mb-3 font-semibold'>
            ...
            <div className='flex justify-start items-center space-x-4 w-[75%]'>
               ...
               {listing.offer && (
                <p className='w-full max-w-[200px] bg-green-800 rounded-md p-1 text-white text-center font-semibold shadow-md'>₹ {+listing.regularPrice - +listing.discountedPrice} discount
                </p>
              )}
              </div>
